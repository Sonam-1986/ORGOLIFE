...
from app.services.auth_service import register_full_donor
...
async def test():
    ...
    try:
        res = await register_full_donor(
            name='Test Donor',
            email='testdonor222@donor.com',
            password='12345678',
        ...
        print('SUCCESS DONOR!', res)
    except Exception as e:
        print('FAIL DONOR!', type(e), str(e))
